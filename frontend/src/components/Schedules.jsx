            ...
            <div className="App-body">
                ...
                <div className="left-half">
                    ...
                    <input
                        ...
                        value={update_schedule_id}
                        onChange={(e) => set_update_schedule_id(e.target.value)}
                    />
                    <input
                        type="text"
                        placeholder="New Schedule Name"
                        value={update_schedule_new_name}
                        onChange={(e) => set_update_schedule_new_name(e.target.value)}
                    />
                    ...
                    <input
                        ...
                        value={create_schedule_new_name}
                        onChange={(e) => set_create_schedule_new_name(e.target.value)}
                    />
                    ...
                    <input
                        type="number"
                        placeholder="Schedule ID"
                        value={delete_schedule_id}
                        onChange={(e) => set_delete_schedule_id(e.target.value)}
                    />
